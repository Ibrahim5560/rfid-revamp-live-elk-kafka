...
@RestController
@RequestMapping("/api/rfid-revamp-live-elk-kafka-kafka")
public class RfidRevampLiveElkKafkaKafkaResource {

    private final Logger log = LoggerFactory.getLogger(RfidRevampLiveElkKafkaKafkaResource.class);
    ...
    public RfidRevampLiveElkKafkaKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
